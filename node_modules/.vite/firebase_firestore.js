...
function lo(t2, e) {
  const n = K2(t2);
  n.Wr.has(e.targetId) || (n.Wr.set(e.targetId, e), go(n) ? mo(n) : $o(n).lr() && wo(n, e));
}
function fo(t2, e) {
  const n = K2(t2), s = $o(n);
...
function go(t2) {
  return yo(t2) && !$o(t2).hr() && t2.Wr.size > 0;
}
function yo(t2) {
...
function Vo(t2) {
  return yo(t2) && !Oo(t2).hr() && t2.Qr.length > 0;
}
function So(t2) {
  Oo(t2).start();
}
...
async function ko(t2, e) {
  e && Oo(t2).Sr && await async function(t3, e2) {
    if (n = e2.code, mn(n) && n !== j.ABORTED) {
      const n2 = t3.Qr.shift();
      Oo(t3).wr(), await Ro(t3, () => t3.remoteSyncer.rejectFailedWrite(n2.batchId, e2)), await bo(t3);
    }
    var n;
  }(t2, e), Vo(t2) && So(t2);
}
...
var Mo = class {
  ...
  static createAndSchedule(t2, e, n, s, i) {
    const r = Date.now() + n, o = new Mo(t2, e, r, s, i);
    return o.start(n), o;
  }
  start(t2) {
...
var Uo = class {
  ...
  static fromInitialDocuments(t2, e, n, s) {
    ...
    }), new Uo(t2, e, Lo.emptySet(e), i, n, s, true, false);
  }
  get hasPendingWrites() {
...
async function jo(t2, e) {
  ...
  if (r || (i = true, r = new qo()), i)
    try {
      r.so = await n.onListen(s);
    } catch (t3) {
      const n2 = Fo(t3, `Initialization of query '${Se(e.query)}' failed`);
...
var Ho = class {
  ...
  oo(t2) {
    if (!this.options.includeMetadataChanges) {
      ...
      for (const n of t2.docChanges)
        n.type !== 3 && e2.push(n);
      t2 = new Uo(t2.query, t2.docs, t2.oldDocs, e2, t2.mutatedKeys, t2.fromCache, t2.syncStateChanged, true);
    }
    let e = false;
  ...
  fo(t2) {
    t2 = Uo.fromInitialDocuments(t2.query, t2.docs, t2.mutatedKeys, t2.fromCache), this.ao = true, this.co.next(t2);
  }
};
var Jo = class {
  constructor(t2, e) {
...
var Xo = class {
  constructor(t2, e, n) {
    this.mo = t2, this.localStore = e, this.k = n, this.queries = [], this.documents = [], this.progress = Zo(t2);
  }
  yo(t2) {
  ...
  async complete() {
    const t2 = await Pr(this.localStore, new Yo(this.k), this.documents, this.mo.id), e = this.po(this.documents);
...
var nc2 = class {
  constructor(t2, e) {
    this.query = t2, this.To = e, this.Eo = null, this.current = false, this.Io = Dn(), this.mutatedKeys = Dn(), this.Ao = Ce(t2), this.Ro = new Lo(this.Ao);
  }
  get bo() {
    return this.To;
  }
  ...
  applyChanges(t2, e, n) {
    ...
    if (this.Eo = o, i.length !== 0 || c) {
      return {
        snapshot: new Uo(this.query, t2.Ro, s, i, t2.mutatedKeys, o === 0, c, false),
        Co: r
      };
    }
    return {
  ...
  Do() {
    ...
    const e = [];
    return t2.forEach((t3) => {
      this.Io.has(t3) || e.push(new ec2(t3));
    }), this.Io.forEach((n) => {
      t2.has(n) || e.push(new tc2(n));
    }), e;
  }
  ko(t2) {
  ...
  xo() {
    return Uo.fromInitialDocuments(this.query, this.Ro, this.mutatedKeys, this.Eo === 0);
  }
};
var sc2 = class {
  constructor(t2, e, n) {
...
async function oc2(t2, e) {
  ...
  if (r)
    ...
    s = t3.targetId, i = await cc2(n, e, s, r2 === "current"), n.isPrimaryClient && lo(n.remoteStore, t3);
  }
  return i;
}
async function cc2(t2, e, n, s) {
  t2.Go = (e2, n2, s2) => async function(t3, e3, n3, s3) {
    ...
    return Tc2(t3, e3.targetId, o2.Co), o2.snapshot;
  }(t2, e2, n2, s2);
  const i = await Ir(t2.localStore, e, true), r = new nc2(e, i.zn), o = r.Po(i.documents), c = xn.createSynthesizedTargetChangeForCurrentChange(n, s && t2.onlineState !== "Offline"), a = r.applyChanges(o, t2.isPrimaryClient, c);
  Tc2(t2, n, a.Co);
  const u = new sc2(e, n, r);
...
async function ac2(t2, e) {
  ...
  if (n.isPrimaryClient) {
    ...
    n.sharedClientState.isActiveQueryTarget(s.targetId) || await Er(n.localStore, s.targetId, false).then(() => {
      n.sharedClientState.clearQueryState(s.targetId), fo(n.remoteStore, s.targetId), yc2(n, s.targetId);
    }).catch(Ui);
  } else
    yc2(n, s.targetId), await Er(n.localStore, s.targetId, true);
}
async function uc2(t2, e, n) {
  ...
  try {
    ...
    }(s, t3.batchId, n), await Ac2(s, t3.changes), await bo(s.remoteStore);
  } catch (t3) {
    const e2 = Fo(t3, "Failed to persist write");
    n.reject(e2);
  }
}
...
async function fc2(t2, e, n) {
  ...
  if (r) {
    ...
    await hc2(s, i2), s.Bo = s.Bo.remove(r), s.Uo.delete(e), Ic2(s);
  } else
    await Er(s.localStore, e, false).then(() => yc2(s, e, n)).catch(Ui);
}
async function dc2(t2, e) {
  const n = K2(t2), s = e.batch.batchId;
  try {
    const t3 = await _r(n.localStore, e);
    gc2(n, s, null), mc2(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), await Ac2(n, t3);
  } catch (t3) {
    await Ui(t3);
  }
}
async function wc2(t2, e, n) {
  ...
  try {
    ...
    gc2(s, e, n), mc2(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), await Ac2(s, t3);
  } catch (n2) {
    await Ui(n2);
  }
}
async function _c(t2, e) {
  ...
  try {
    ...
    const n2 = Fo(t3, "Initialization of waitForPendingWrites() operation failed");
    e.reject(n2);
  }
}
function mc2(t2, e) {
...
function yc2(t2, e, n = null) {
  ...
  if (t2.Fo.delete(e), t2.isPrimaryClient) {
    t2.qo.us(e).forEach((e2) => {
      t2.qo.containsKey(e2) || pc2(t2, e2);
    });
  }
}
function pc2(t2, e) {
  ...
  const n = t2.Bo.get(e);
  n !== null && (fo(t2.remoteStore, n), t2.Bo = t2.Bo.remove(e), t2.Uo.delete(n), Ic2(t2));
}
function Tc2(t2, e, n) {
  for (const s of n)
    if (s instanceof tc2)
      t2.qo.addReference(s.key, e), Ec2(t2, s);
    else if (s instanceof ec2) {
      O2("SyncEngine", "Document no longer in limbo: " + s.key), t2.qo.removeReference(s.key, e);
      t2.qo.containsKey(s.key) || pc2(t2, s.key);
    } else
      B2();
}
function Ec2(t2, e) {
  const n = e.key, s = n.path.canonicalString();
  t2.Bo.get(n) || t2.Lo.has(s) || (O2("SyncEngine", "New document in limbo: " + n), t2.Lo.add(s), Ic2(t2));
}
function Ic2(t2) {
  for (; t2.Lo.size > 0 && t2.Bo.size < t2.maxConcurrentLimboResolutions; ) {
    ...
    t2.Uo.set(s, new ic2(n)), t2.Bo = t2.Bo.insert(n, s), lo(t2.remoteStore, new ai(be(ye(n.path)), s, 2, nt.I));
  }
}
...
async function Rc2(t2, e) {
  ...
  if (!n.currentUser.isEqual(e)) {
    ...
    }(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(e, t3.removedBatchIds, t3.addedBatchIds), await Ac2(n, t3.Gn);
  }
}
function bc2(t2, e) {
...
async function Pc2(t2, e) {
  ...
  return n.isPrimaryClient && Tc2(n, e.targetId, i.Co), i;
}
async function vc2(t2) {
  const e = K2(t2);
  return Rr(e.localStore).then((t3) => Ac2(e, t3));
}
async function Vc2(t2, e, n, s) {
  ...
  r !== null ? (n === "pending" ? await bo(i.remoteStore) : n === "acknowledged" || n === "rejected" ? (gc2(i, e, s || null), mc2(i, e), function(t3, e2) {
    K2(K2(t3).An).ee(e2);
  }(i.localStore, e)) : B2(), await Ac2(i, r)) : O2("SyncEngine", "Cannot apply mutation batch with id: " + e);
}
async function Sc2(t2, e) {
  const n = K2(t2);
  if ($c2(n), Oc2(n), e === true && n.Wo !== true) {
    const t3 = n.sharedClientState.getAllActiveQueryTargets(), e2 = await Dc2(n, t3.toArray());
    n.Wo = true, await xo(n.remoteStore, true);
    for (const t4 of e2)
      lo(n.remoteStore, t4);
    ...
    n.Fo.forEach((s, i) => {
      n.sharedClientState.isLocalQueryTarget(i) ? t3.push(i) : e2 = e2.then(() => (yc2(n, i), Er(n.localStore, i, true))), fo(n.remoteStore, i);
    }), await e2, await Dc2(n, t3), function(t4) {
      const e3 = K2(t4);
      e3.Uo.forEach((t5, n2) => {
        fo(e3.remoteStore, n2);
      }), e3.qo.hs(), e3.Uo = new Map(), e3.Bo = new yn(Dt.comparator);
    }(n), n.Wo = false, await xo(n.remoteStore, false);
  }
}
async function Dc2(t2, e, n) {
  ...
  for (const t3 of e) {
    ...
    if (n2 && n2.length !== 0) {
      ...
      for (const t4 of n2) {
        const e3 = s.Mo.get(t4), n3 = await Pc2(s, e3);
        n3.snapshot && r.push(n3.snapshot);
      }
    } else {
      const n3 = await Ar(s.localStore, t3);
      e2 = await Tr(s.localStore, n3), await cc2(s, Cc2(n3), t3, false);
    }
    i.push(e2);
  }
  return s.Oo.br(r), i;
...
async function kc2(t2, e, n, s) {
  ...
  if (i.Wo)
    ...
    switch (n) {
      ...
      case "rejected":
        await Er(i.localStore, e, true), yc2(i, e, s);
        break;
      default:
        B2();
    }
...
async function xc2(t2, e, n) {
  ...
  if (s.Wo) {
    for (const t3 of e) {
      ...
      await cc2(s, Cc2(e2), n2.targetId, false), lo(s.remoteStore, n2);
    }
    for (const t3 of n)
      s.Fo.has(t3) && await Er(s.localStore, t3, false).then(() => {
        fo(s.remoteStore, t3), yc2(s, t3);
      }).catch(Ui);
  }
}
function $c2(t2) {
  const e = K2(t2);
  return e.remoteStore.remoteSyncer.applyRemoteEvent = hc2.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = bc2.bind(null, e), e.remoteStore.remoteSyncer.rejectListen = fc2.bind(null, e), e.Oo.br = Wo.bind(null, e.eventManager), e.Oo.zo = Go.bind(null, e.eventManager), e;
}
function Oc2(t2) {
  const e = K2(t2);
  return e.remoteStore.remoteSyncer.applySuccessfulWrite = dc2.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = wc2.bind(null, e), e;
}
function Mc2(t2, e, n) {
  const s = K2(t2);
  (async function(t3, e2, n2) {
    try {
      ...
      const i = new Xo(s2, t3.localStore, e2.k);
      let r = await e2.Ho();
      for (; r; ) {
      ...
      await Ac2(t3, o.In, void 0), await function(t4, e3) {
        const n3 = K2(t4);
...
var Lc2 = class extends Fc2 {
  constructor(t2, e, n) {
    super(), this.tc = t2, this.cacheSizeBytes = e, this.forceOwnership = n, this.synchronizeTabs = false;
  }
  async initialize(t2) {
    await super.initialize(t2), await br(this.localStore), await this.tc.initialize(this, t2), await Oc2(this.tc.syncEngine), await bo(this.tc.remoteStore), await this.persistence.sn(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(this.localStore), Promise.resolve()));
  }
  Zo(t2) {
    return dr(this.persistence, new lr(), t2.initialUser, this.k);
  }
...
var Bc2 = class extends Lc2 {
  ...
  async initialize(t2) {
    ...
    this.sharedClientState instanceof Wr && (this.sharedClientState.syncEngine = {
      ...
      await Sc2(this.tc.syncEngine, t3), this.gcScheduler && (t3 && !this.gcScheduler.started ? this.gcScheduler.start(this.localStore) : t3 || this.gcScheduler.stop());
    });
  }
  Jo(t2) {
    const e = Zr();
...
var Uc2 = class {
  async initialize(t2, e) {
    this.localStore || (this.localStore = t2.localStore, this.sharedClientState = t2.sharedClientState, this.datastore = this.createDatastore(e), this.remoteStore = this.createRemoteStore(e), this.eventManager = this.createEventManager(e), this.syncEngine = this.createSyncEngine(e, !t2.synchronizeTabs), this.sharedClientState.onlineStateHandler = (t3) => lc2(this.syncEngine, t3, 1), this.remoteStore.remoteSyncer.handleCredentialChange = Rc2.bind(null, this.syncEngine), await xo(this.remoteStore, this.syncEngine.isPrimaryClient));
  }
  ...
  createRemoteStore(t2) {
    return e = this.localStore, n = this.datastore, s = t2.asyncQueue, i = (t3) => lc2(this.syncEngine, t3, 0), r = Hr.Pt() ? new Hr() : new zr(), new ao(e, n, s, i, r);
    var e, n, s, i, r;
  }
  createSyncEngine(t2, e) {
    return function(t3, e2, n, s, i, r, o) {
      const c = new rc2(t3, e2, n, s, i, r);
...
var Wc2 = class {
  ...
  fc() {
    this.ur.Zi(async () => {
      const t2 = new Qc2(this.datastore), e = this.dc(t2);
      e && e.then((e2) => {
...
var Gc2 = class {
  constructor(t2, e, n, s) {
    this.authCredentials = t2, this.appCheckCredentials = e, this.asyncQueue = n, this.databaseInfo = s, this.user = C2.UNAUTHENTICATED, this.clientId = it.A(), this.authCredentialListener = () => Promise.resolve(), this.authCredentials.start(n, async (t3) => {
...
async function Hc2(t2, e) {
  ...
  await e.initialize(n, s), t2.setCredentialChangeListener((t3) => async function(t4, e2) {
    ...
    const s2 = yo(n2);
    n2.Gr.add(3), await ho(n2), s2 && n2.Jr.set("Unknown"), await n2.remoteSyncer.handleCredentialChange(e2), n2.Gr.delete(3), await uo(n2);
  }(e.remoteStore, t3)), t2.onlineComponents = e;
}
async function Jc2(t2) {
  return t2.offlineComponents || (O2("FirestoreClient", "Using default OfflineComponentProvider"), await zc2(t2, new Fc2())), t2.offlineComponents;
}
async function Yc2(t2) {
  return t2.onlineComponents || (O2("FirestoreClient", "Using default OnlineComponentProvider"), await Hc2(t2, new Uc2())), t2.onlineComponents;
}
function Xc2(t2) {
  return Jc2(t2).then((t3) => t3.persistence);
}
function Zc2(t2) {
  return Jc2(t2).then((t3) => t3.localStore);
}
function ta2(t2) {
  return Yc2(t2).then((t3) => t3.remoteStore);
}
function ea2(t2) {
  return Yc2(t2).then((t3) => t3.syncEngine);
}
async function na2(t2) {
  const e = await Yc2(t2), n = e.eventManager;
  return n.onListen = oc2.bind(null, e.syncEngine), n.onUnlisten = ac2.bind(null, e.syncEngine), n;
}
function sa2(t2) {
  return t2.asyncQueue.enqueue(async () => {
    const e = await Xc2(t2), n = await ta2(t2);
...
function ra2(t2, e) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => async function(t3, e2, n2) {
    try {
      ...
      const s = Fo(t4, `Failed to get document '${e2} from cache`);
      n2.reject(s);
    }
  }(await Zc2(t2), e, n)), n.promise;
}
function oa2(t2, e, n = {}) {
  const s = new W2();
  return t2.asyncQueue.enqueueAndForget(async () => function(t3, e2, n2, s2, i) {
    ...
    }), o = new Ho(ye(n2.path), r, {
      includeMetadataChanges: true,
      wo: true
    });
    return jo(t3, o);
  }(await na2(t2), t2.asyncQueue, e, n, s)), s.promise;
}
function ca(t2, e) {
  const n = new W2();
  return t2.asyncQueue.enqueueAndForget(async () => async function(t3, e2, n2) {
    try {
      const s = await Ir(t3, e2, true), i = new nc2(e2, s.zn), r = i.Po(s.documents), o = i.applyChanges(r, false);
      n2.resolve(o.snapshot);
    } catch (t4) {
      const s = Fo(t4, `Failed to execute query '${e2} against cache`);
      n2.reject(s);
    }
  }(await Zc2(t2), e, n)), n.promise;
}
function aa2(t2, e, n = {}) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => function(t3, e2, n2, s2, i) {
    const r = new Kc2({
      next: (n3) => {
        e2.enqueueAndForget(() => Qo(t3, o)), n3.fromCache && s2.source === "server" ? i.reject(new Q2(j.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n3);
      },
      error: (t4) => i.reject(t4)
    }), o = new Ho(n2, r, {
      includeMetadataChanges: true,
...
function ha2(t2, e) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => {
    const s = await function(t3) {
      return Yc2(t3).then((t4) => t4.datastore);
    }(t2);
    new Wc2(t2.asyncQueue, s, e, n).run();
  }), n.promise;
}
...
var wa = class {
  ...
  isEqual(t2) {
    return t2 instanceof wa && t2.projectId === this.projectId && t2.database === this.database;
  }
};
var _a = new Map();
function ma2(t2, e, n) {
...
var Ra2 = class {
  constructor(t2, e, n) {
    this._authCredentials = e, this._appCheckCredentials = n, this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new Aa2({}), this._settingsFrozen = false, t2 instanceof wa ? this._databaseId = t2 : (this._app = t2, this._databaseId = function(t3) {
      ...
      return new wa(t3.options.projectId);
    }(t2));
  }
  get app() {
    if (!this._app)
  ...
  _setSettings(t2) {
    ...
    this._settings = new Aa2(t2), t2.credentials !== void 0 && (this._authCredentials = function(t3) {
      if (!t3)
        return new z2();
      switch (t3.type) {
        case "gapi":
  ...
  _terminate() {
    return function(t2) {
      const e = _a.get(t2);
      e && (O2("ComponentProvider", "Removing Datastore"), _a.delete(t2), e.terminate());
    }(this), Promise.resolve();
  }
};
function ba2(t2, e, n, s = {}) {
  var i;
  const r = (t2 = Ea(t2, Ra2))._getSettings();
...
var Pa = class {
  ...
  get parent() {
    return new Va2(this.firestore, this.converter, this._key.path.popLast());
  }
  withConverter(t2) {
    return new Pa(this.firestore, t2, this._key);
  }
};
var va = class {
  constructor(t2, e, n) {
...
var Va2 = class extends va {
  ...
  get parent() {
    ...
    return t2.isEmpty() ? null : new Pa(this.firestore, null, new Dt(t2));
  }
  withConverter(t2) {
    return new Va2(this.firestore, t2, this._path);
  }
};
function Sa2(t2, e, ...n) {
  if (t2 = getModularInstance(t2), ma2("collection", "path", e), t2 instanceof Ra2) {
    const s = wt.fromString(e, ...n);
    return pa2(s), new Va2(t2, null, s);
  }
  {
    if (!(t2 instanceof Pa || t2 instanceof Va2))
    ...
    return pa2(s), new Va2(t2.firestore, null, s);
  }
}
function Da(t2, e) {
  if (t2 = Ea(t2, Ra2), ma2("collectionGroup", "collection id", e), e.indexOf("/") >= 0)
  ...
  return new va(t2, null, function(t3) {
    return new me(wt.emptyPath(), t3);
  }(e));
}
function Ca2(t2, e, ...n) {
  if (t2 = getModularInstance(t2), arguments.length === 1 && (e = it.A()), ma2("doc", "path", e), t2 instanceof Ra2) {
    const s = wt.fromString(e, ...n);
    return ya2(s), new Pa(t2, null, new Dt(s));
  }
  {
    if (!(t2 instanceof Pa || t2 instanceof Va2))
      throw new Q2(j.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    const s = t2._path.child(wt.fromString(e, ...n));
    return ya2(s), new Pa(t2.firestore, t2 instanceof Va2 ? t2.converter : null, new Dt(s));
  }
}
function Na2(t2, e) {
  return t2 = getModularInstance(t2), e = getModularInstance(e), (t2 instanceof Pa || t2 instanceof Va2) && (e instanceof Pa || e instanceof Va2) && (t2.firestore === e.firestore && t2.path === e.path && t2.converter === e.converter);
}
function ka2(t2, e) {
  return t2 = getModularInstance(t2), e = getModularInstance(e), t2 instanceof va && e instanceof va && (t2.firestore === e.firestore && ve(t2._query, e._query) && t2.converter === e.converter);
}
var xa2 = class {
  constructor() {
  ...
  enqueueAfterDelay(t2, e, n) {
    ...
    const s = Mo.createAndSchedule(this, t2, e, n, (t3) => this.Sc(t3));
...
var Ma2 = -1;
var Fa2 = class extends Ra2 {
  constructor(t2, e, n) {
    super(t2, e, n), this.type = "firestore", this._queue = new xa2(), this._persistenceKey = "name" in t2 ? t2.name : "[DEFAULT]";
  }
  _terminate() {
...
function qa2(t2) {
  ...
  const n = t2._freezeSettings(), s = function(t3, e2, n2, s2) {
    return new da2(t3, e2, n2, s2.host, s2.ssl, s2.experimentalForceLongPolling, s2.experimentalAutoDetectLongPolling, s2.useFetchStreams);
...
function Ka2(t2, e) {
  Za2(t2 = Ea(t2, Fa2));
  const n = Ua2(t2), s = t2._freezeSettings(), i = new Uc2();
  return Qa(n, i, new Lc2(i, s.cacheSizeBytes, e == null ? void 0 : e.forceOwnership));
}
function ja2(t2) {
  Za2(t2 = Ea(t2, Fa2));
  const e = Ua2(t2), n = t2._freezeSettings(), s = new Uc2();
  return Qa(e, s, new Bc2(s, n.cacheSizeBytes));
}
function Qa(t2, e, n) {
  const s = new W2();
  return t2.asyncQueue.enqueue(async () => {
    try {
      await zc2(t2, n), await Hc2(t2, e), s.resolve();
    } catch (t3) {
      if (!function(t4) {
...
function za2(t2) {
  return sa2(Ua2(t2 = Ea(t2, Fa2)));
}
function Ha2(t2) {
  return ia2(Ua2(t2 = Ea(t2, Fa2)));
}
function Ja2(t2) {
  return _removeServiceInstance(t2.app, "firestore"), t2._delete();
}
function Ya2(t2, e) {
  const n = Ua2(t2 = Ea(t2, Fa2)), s = new Oa();
  return la2(n, t2._databaseId, e, s), s;
}
function Xa2(t2, e) {
  return fa2(Ua2(t2 = Ea(t2, Fa2)), e).then((e2) => e2 ? new va(t2, null, e2.query) : null);
}
function Za2(t2) {
  if (t2._initialized || t2._terminated)
...
var uu = class {
  ...
  Oc(t2) {
    return new uu(Object.assign(Object.assign({}, this.settings), t2), this.databaseId, this.k, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
  }
  Mc(t2) {
    var e;
  ...
  qc(t2) {
    return Su(t2, this.settings.methodName, this.settings.Kc || false, this.path, this.settings.jc);
  }
  contains(t2) {
...
function lu(t2) {
  ...
  return new hu(t2._databaseId, !!e.ignoreUndefinedProperties, n);
}
function fu(t2, e, n, s, i, r = {}) {
...
var _u = class extends su {
  _toFieldTransform(t2) {
    return new ze(t2.path, new Be());
  }
  isEqual(t2) {
    return t2 instanceof _u;
  }
};
var mu = class extends su {
  ...
  _toFieldTransform(t2) {
    const e = wu(this, t2, true), n = this.Wc.map((t3) => Iu(t3, e)), s = new Ue(n);
...
var gu = class extends su {
  constructor(t2, e) {
    super(t2), this.Wc = e;
  }
  _toFieldTransform(t2) {
    const e = wu(this, t2, true), n = this.Wc.map((t3) => Iu(t3, e)), s = new Ke(n);
    return new ze(t2.path, s);
  }
  isEqual(t2) {
    return this === t2;
...
function Tu(t2, e, n, s, i, r) {
  const o = t2.Qc(1, e, n), c = [Pu(e, s, n)], a = [i];
  if (r.length % 2 != 0)
  ...
  for (let t3 = 0; t3 < r.length; t3 += 2)
    c.push(Pu(e, r[t3])), a.push(r[t3 + 1]);
  const u = [], h = Qt.empty();
  ...
  const l2 = new gt(u);
  return new cu(h, l2, o.fieldTransforms);
}
function Eu(t2, e, n, s = false) {
  return Iu(n, t2.Qc(s ? 4 : 3, e));
}
function Iu(t2, e) {
  if (Ru(t2 = getModularInstance(t2)))
    return bu("Unsupported field value:", e, t2), Au(t2, e);
  if (t2 instanceof su)
    return function(t3, e2) {
      if (!au(e2.$c))
...
function Ru(t2) {
  return !(typeof t2 != "object" || t2 === null || t2 instanceof Array || t2 instanceof Date || t2 instanceof at || t2 instanceof iu || t2 instanceof nu || t2 instanceof Pa || t2 instanceof su);
}
function bu(t2, e, n) {
  if (!Ru(n) || !function(t3) {
...
function Pu(t2, e, n) {
  if ((e = getModularInstance(e)) instanceof tu)
    return e._internalPath;
  if (typeof e == "string")
    return Vu(t2, e);
  throw Su("Field path arguments must be of type string or ", t2, false, void 0, n);
}
var vu = new RegExp("[~\\*/\\[\\]]");
function Vu(t2, e, n) {
  if (e.search(vu) >= 0)
    throw Su(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t2, false, void 0, n);
  try {
    return new tu(...e.split("."))._internalPath;
  } catch (s) {
    throw Su(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t2, false, void 0, n);
  }
}
function Su(t2, e, n, s, i) {
...
var Cu = class {
  ...
  data() {
    if (this._document) {
      if (this._converter) {
        const t2 = new Nu(this._firestore, this._userDataWriter, this._key, this._document, null);
  ...
  get(t2) {
    if (this._document) {
      const e = this._document.data.field(ku("DocumentSnapshot.get", t2));
      if (e !== null)
...
function ku(t2, e) {
  return typeof e == "string" ? Vu(t2, e) : e instanceof tu ? e._internalPath : e._delegate._internalPath;
}
var xu = class {
  constructor(t2, e) {
...
var $u = class extends Cu {
  ...
  data(t2 = {}) {
    if (this._document) {
      if (this._converter) {
        const e = new Ou(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, null);
  ...
  get(t2, e = {}) {
    if (this._document) {
      const n = this._document.data.field(ku("DocumentSnapshot.get", t2));
      if (n !== null)
        return this._userDataWriter.convertValue(n, e.serverTimestamps);
    }
  }
};
var Ou = class extends $u {
  data(t2 = {}) {
...
var Mu = class {
  constructor(t2, e, n, s) {
    this._firestore = t2, this._userDataWriter = e, this._snapshot = s, this.metadata = new xu(s.hasPendingWrites, s.fromCache), this.query = n;
  }
  get docs() {
    const t2 = [];
  ...
  forEach(t2, e) {
    this._snapshot.docs.forEach((n) => {
      t2.call(e, new Ou(this._firestore, this._userDataWriter, n.key, n, new xu(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
    });
  }
  docChanges(t2 = {}) {
    ...
    return this._cachedChanges && this._cachedChangesIncludeMetadataChanges === e || (this._cachedChanges = function(t3, e2) {
      if (t3._snapshot.oldDocs.isEmpty()) {
        ...
        return t3._snapshot.docChanges.map((n) => ({
          type: "added",
          doc: new Ou(t3._firestore, t3._userDataWriter, n.doc.key, n.doc, new xu(t3._snapshot.mutatedKeys.has(n.doc.key), t3._snapshot.fromCache), t3.query.converter),
          oldIndex: -1,
          newIndex: e3++
        }));
      }
      {
        ...
        return t3._snapshot.docChanges.filter((t4) => e2 || t4.type !== 3).map((e3) => {
          const s = new Ou(t3._firestore, t3._userDataWriter, e3.doc.key, e3.doc, new xu(t3._snapshot.mutatedKeys.has(e3.doc.key), t3._snapshot.fromCache), t3.query.converter);
          let i = -1, r = -1;
...
function Lu(t2, e) {
  return t2 instanceof $u && e instanceof $u ? t2._firestore === e._firestore && t2._key.isEqual(e._key) && (t2._document === null ? e._document === null : t2._document.isEqual(e._document)) && t2._converter === e._converter : t2 instanceof Mu && e instanceof Mu && (t2._firestore === e._firestore && ka2(t2.query, e.query) && t2.metadata.isEqual(e.metadata) && t2._snapshot.isEqual(e._snapshot));
}
function Bu(t2) {
...
var Ku = class extends Uu {
  ...
  _apply(t2) {
    const e = lu(t2.firestore), n = function(t3, e2, n2, s, i, r, o) {
      let c;
      if (i.isKeyField()) {
        ...
        r !== "in" && r !== "not-in" && r !== "array-contains-any" || ih(o, r), c = Eu(n2, e2, o, r === "in" || r === "not-in");
...
function ju(t2, e, n) {
  const s = e, i = ku("where", t2);
  return new Ku(i, s, n);
}
var Qu = class extends Uu {
  constructor(t2, e) {
...
function Wu(t2, e = "asc") {
  const n = e, s = ku("orderBy", t2);
  return new Qu(s, n);
}
var Gu = class extends Uu {
  constructor(t2, e, n) {
    super(), this.type = t2, this.Xc = e, this.Zc = n;
  }
  _apply(t2) {
    return new va(t2.firestore, t2.converter, Pe(t2._query, this.Xc, this.Zc));
  }
};
function zu(t2) {
  return Ia2("limit", t2), new Gu("limit", t2, "F");
}
function Hu(t2) {
  return Ia2("limitToLast", t2), new Gu("limitToLast", t2, "L");
}
var Ju = class extends Uu {
  ...
  _apply(t2) {
    const e = nh(t2, this.type, this.ta, this.ea);
    return new va(t2.firestore, t2.converter, function(t3, e2) {
...
function nh(t2, e, n, s) {
  if (n[0] = getModularInstance(n[0]), n[0] instanceof Cu)
...
function sh(t2, e, n) {
  ...
  if (n instanceof Pa)
    return Ft(t2, n._key);
  throw new Q2(j.INVALID_ARGUMENT, `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Ta(n)}.`);
}
function ih(t2, e) {
...
var oh = class {
  ...
  convertGeoPoint(t2) {
    return new iu(It(t2.latitude), It(t2.longitude));
  }
  convertArray(t2, e) {
...
var ah = class extends oh {
  ...
  convertReference(t2) {
    ...
    return new Pa(this.firestore, null, e);
  }
};
var uh = class {
  constructor(t2, e) {
    this._firestore = t2, this._commitHandler = e, this._mutations = [], this._committed = false, this._dataReader = lu(t2);
  }
  set(t2, e, n) {
    this._verifyNotCommitted();
    const s = hh(t2, this._firestore), i = ch(s.converter, e, n), r = fu(this._dataReader, "WriteBatch.set", s._key, i, s.converter !== null, n);
    return this._mutations.push(r.toMutation(s._key, Ye.none())), this;
  }
  update(t2, e, n, ...s) {
    this._verifyNotCommitted();
    const i = hh(t2, this._firestore);
    let r;
    return r = typeof (e = getModularInstance(e)) == "string" || e instanceof tu ? Tu(this._dataReader, "WriteBatch.update", i._key, e, n, s) : pu(this._dataReader, "WriteBatch.update", i._key, e), this._mutations.push(r.toMutation(i._key, Ye.exists(true))), this;
  }
  delete(t2) {
    this._verifyNotCommitted();
    const e = hh(t2, this._firestore);
...
function lh(t2) {
  t2 = Ea(t2, Pa);
  const e = Ea(t2.firestore, Fa2);
  return oa2(Ua2(e), t2._key).then((n) => bh(e, t2, n));
}
...
function dh(t2) {
  t2 = Ea(t2, Pa);
  const e = Ea(t2.firestore, Fa2), n = Ua2(e), s = new fh(e);
  return ra2(n, t2._key).then((n2) => new $u(e, s, t2._key, n2, new xu(n2 !== null && n2.hasLocalMutations, true), t2.converter));
}
function wh(t2) {
  t2 = Ea(t2, Pa);
  const e = Ea(t2.firestore, Fa2);
  return oa2(Ua2(e), t2._key, {
    source: "server"
  }).then((n) => bh(e, t2, n));
}
function _h(t2) {
  t2 = Ea(t2, va);
  const e = Ea(t2.firestore, Fa2), n = Ua2(e), s = new fh(e);
  return Bu(t2._query), aa2(n, t2._query).then((n2) => new Mu(e, s, t2, n2));
}
function mh(t2) {
  t2 = Ea(t2, va);
  const e = Ea(t2.firestore, Fa2), n = Ua2(e), s = new fh(e);
  return ca(n, t2._query).then((n2) => new Mu(e, s, t2, n2));
}
function gh(t2) {
  t2 = Ea(t2, va);
  const e = Ea(t2.firestore, Fa2), n = Ua2(e), s = new fh(e);
  return aa2(n, t2._query, {
    source: "server"
  }).then((n2) => new Mu(e, s, t2, n2));
}
function yh(t2, e, n) {
  t2 = Ea(t2, Pa);
  const s = Ea(t2.firestore, Fa2), i = ch(t2.converter, e, n);
  return Rh(s, [fu(lu(s), "setDoc", t2._key, i, t2.converter !== null, n).toMutation(t2._key, Ye.none())]);
}
function ph(t2, e, n, ...s) {
  t2 = Ea(t2, Pa);
  const i = Ea(t2.firestore, Fa2), r = lu(i);
  let o;
  o = typeof (e = getModularInstance(e)) == "string" || e instanceof tu ? Tu(r, "updateDoc", t2._key, e, n, s) : pu(r, "updateDoc", t2._key, e);
  return Rh(i, [o.toMutation(t2._key, Ye.exists(true))]);
}
function Th(t2) {
  return Rh(Ea(t2.firestore, Fa2), [new ln(t2._key, Ye.none())]);
}
function Eh(t2, e) {
  const n = Ea(t2.firestore, Fa2), s = Ca2(t2), i = ch(t2.converter, e);
  return Rh(n, [fu(lu(t2.firestore), "addDoc", s._key, i, t2.converter !== null, {}).toMutation(s._key, Ye.exists(false))]).then(() => s);
}
function Ih(t2, ...e) {
  var n, s, i;
  ...
  typeof e[o] != "object" || $a2(e[o]) || (r = e[o], o++);
  const c = {
  ...
  let a, u, h;
  if (t2 instanceof Pa)
    u = Ea(t2.firestore, Fa2), h = ye(t2._key.path), a = {
      next: (n2) => {
        e[o] && e[o](bh(u, t2, n2));
      },
      error: e[o + 1],
    ...
    const n2 = Ea(t2, va);
    u = Ea(n2.firestore, Fa2), h = n2._query;
    const s2 = new fh(u);
    a = {
      next: (t3) => {
        e[o] && e[o](new Mu(u, s2, n2, t3));
      },
      error: e[o + 1],
      complete: e[o + 2]
    }, Bu(t2._query);
  ...
  return function(t3, e2, n2, s2) {
    const i2 = new Kc2(s2), r2 = new Ho(e2, i2, n2);
    return t3.asyncQueue.enqueueAndForget(async () => jo(await na2(t3), r2)), () => {
      i2.nc(), t3.asyncQueue.enqueueAndForget(async () => Qo(await na2(t3), r2));
    };
  }(Ua2(u), h, c, a);
}
function Ah(t2, e) {
  return ua2(Ua2(t2 = Ea(t2, Fa2)), $a2(e) ? e : {
    next: e
  });
}
function Rh(t2, e) {
  return function(t3, e2) {
    const n = new W2();
    return t3.asyncQueue.enqueueAndForget(async () => uc2(await ea2(t3), e2, n)), n.promise;
  }(Ua2(t2), e);
}
function bh(t2, e, n) {
  const s = n.docs.get(e._key), i = new fh(t2);
  return new $u(t2, i, e._key, s, new xu(n.hasPendingWrites, n.fromCache), e.converter);
}
var Ph = class extends class {
  constructor(t2, e) {
    this._firestore = t2, this._transaction = e, this._dataReader = lu(t2);
  }
  get(t2) {
    const e = hh(t2, this._firestore), n = new ah(this._firestore);
    return this._transaction.lookup([e._key]).then((t3) => {
      if (!t3 || t3.length !== 1)
        return B2();
      const s = t3[0];
      if (s.isFoundDocument())
        return new Cu(this._firestore, n, s.key, s, e.converter);
      if (s.isNoDocument())
        return new Cu(this._firestore, n, e._key, null, e.converter);
      throw B2();
    });
  }
  set(t2, e, n) {
    const s = hh(t2, this._firestore), i = ch(s.converter, e, n), r = fu(this._dataReader, "Transaction.set", s._key, i, s.converter !== null, n);
    return this._transaction.set(s._key, r), this;
  }
  update(t2, e, n, ...s) {
    const i = hh(t2, this._firestore);
    let r;
    return r = typeof (e = getModularInstance(e)) == "string" || e instanceof tu ? Tu(this._dataReader, "Transaction.update", i._key, e, n, s) : pu(this._dataReader, "Transaction.update", i._key, e), this._transaction.update(i._key, r), this;
  }
  delete(t2) {
    const e = hh(t2, this._firestore);
  ...
  get(t2) {
    const e = hh(t2, this._firestore), n = new fh(this._firestore);
    return super.get(t2).then((t3) => new $u(this._firestore, n, e._key, t3._document, new xu(false, false), e.converter));
  }
};
function vh(t2, e) {
  return ha2(Ua2(t2 = Ea(t2, Fa2)), (n) => e(new Ph(t2, n)));
}
function Vh() {
...
function Dh(...t2) {
  return new mu("arrayUnion", t2);
}
function Ch(...t2) {
  return new gu("arrayRemove", t2);
}
function Nh(t2) {
  return new yu("increment", t2);
}
function kh(t2) {
  return Ua2(t2 = Ea(t2, Fa2)), new uh(t2, (e) => Rh(t2, e));
}
!function(t2, e = true) {
  !function(t3) {
    N2 = t3;
  ...
  }, "PUBLIC")), registerVersion(D2, "3.4.3", t2), registerVersion(D2, "3.4.3", "esm2017");
}();
export {
  oh as AbstractUserDataWriter,
  nu as Bytes,
  Ma2 as CACHE_SIZE_UNLIMITED,
  Va2 as CollectionReference,
  Pa as DocumentReference,
  $u as DocumentSnapshot,
  tu as FieldPath,
  su as FieldValue,
  Fa2 as Firestore,
  ...
  va as Query,
  Uu as QueryConstraint,
  Ou as QueryDocumentSnapshot,
  Mu as QuerySnapshot,
  xu as SnapshotMetadata,
  at as Timestamp,
  Ph as Transaction,
  uh as WriteBatch,
  wa as _DatabaseId,
  ...
  F2 as _logWarn,
  ga as _validateIsNotUsedTogether,
  Eh as addDoc,
  Ch as arrayRemove,
  Dh as arrayUnion,
  Wa2 as clearIndexedDbPersistence,
  Sa2 as collection,
  Da as collectionGroup,
  ba2 as connectFirestoreEmulator,
  Th as deleteDoc,
  Vh as deleteField,
  Ha2 as disableNetwork,
  Ca2 as doc,
  eu as documentId,
  Ka2 as enableIndexedDbPersistence,
  ja2 as enableMultiTabIndexedDbPersistence,
  ...
  Rh as executeWrite,
  lh as getDoc,
  dh as getDocFromCache,
  wh as getDocFromServer,
  _h as getDocs,
  mh as getDocsFromCache,
  ...
  Xa2 as namedQuery,
  Ih as onSnapshot,
  Ah as onSnapshotsInSync,
  Wu as orderBy,
  qu as query,
  ka2 as queryEqual,
  Na2 as refEqual,
  vh as runTransaction,
  Sh as serverTimestamp,
  yh as setDoc,
  $ as setLogLevel,
  Lu as snapshotEqual,
  Xu as startAfter,
