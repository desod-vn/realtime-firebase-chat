...
var InfiniteScroll = function(_super) {
  ...
  InfiniteScroll2.prototype.render = function() {
    ...
    return import_react.default.createElement("div", { style: outerDivStyle, className: "infinite-scroll-component__outerdiv" }, import_react.default.createElement("div", { className: "infinite-scroll-component " + (this.props.className || ""), ref: function(infScroll) {
      return _this._infScroll = infScroll;
    }, style }, this.props.pullDownToRefresh && import_react.default.createElement("div", { style: { position: "relative" }, ref: function(pullDown) {
...
// dep:react-infinite-scroll-component
var react_infinite_scroll_component_default = index_es_default;
export {
  react_infinite_scroll_component_default as default
};
/*! *****************************************************************************
